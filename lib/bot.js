...
console.log("Omnibot " + p.version);
console.newline(3);
console.log("Contributors:");
console.newline();
for (var contributor of p.contributors) console.logLine("  " + contributor);
console.newline(2);
console.log("Type the channel to connect to (default: #" + options.twitch.channel + "): ");
bot.channel = console.readLine().trim();
...
if (bot.channel == "") bot.channel = options.twitch.channel;
else options.twitch.channel = bot.channel;
...
bot.say = bot.client.say.bind(bot.client);
