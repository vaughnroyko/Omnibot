    ...
    */
    time: function (user, who) {
        ...
        if (util.viewers.isBlacklisted(user)) {
            util.chatter.say(options.output.core.time.blacklisted.format(
            ...
            if (user && "time" in user) {
                util.chatter.say(options.output.core.time.normal.format(
                    user.name,
                    user.time,
                    self
                ));
            } else {
                util.chatter.say(options.output.core.time.unknown.format(
                    user.name,
                    self
                ));
            }
