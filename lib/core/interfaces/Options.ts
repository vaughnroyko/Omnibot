...
export interface ChannelWeavingString extends FancyWeavingString<{ channel: IChannelData }> { }
...
export interface OutputOptions {
	...
	commands: {
		...
		uptime: {
			isLive: FancyWeavingString<{ channel: IChannelData, seconds: number, minutes: number, hours: number, days: number, years: number }>;
