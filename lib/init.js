...
var exiting = false;
var exit = function () {
	if (typeof util != "undefined" && typeof util.chatter != "undefined") util.chatter.log(null, styles.console.info("Shutting down..."));
	else console.log("Shutting down...");
	exiting = true;
	if (global.bot) global.bot.exit();
	else process.exit(global.bot ? global.bot.exitCode : 1);
};
...
process.on('uncaughtException', function (err) {
	...
	if (global.options && global.options.core.exitOnException) process.exit(1);
});

require("weaving").proto();
