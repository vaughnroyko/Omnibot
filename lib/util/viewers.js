...
var handler = module.exports = {
    isBlacklisted: function (user) {
        return options.core.blacklist.indexOf(user.name) + options.core.blacklist.indexOf(user) > -1;
    },
    cleanup: function () {
    ...
    get: function (user) {
        ...
        else if (!("name" in user)) return undefined; 
